...
async def search_web_serp(query: str, max_results: int = 5) -> List[Dict[str, str]]:
    ...
    # Add French-specific keywords to improve results
    french_keywords = ["lyrics", "français", "paroles françaises"]
    enhanced_query = f"{query} {' '.join(french_keywords)}"
