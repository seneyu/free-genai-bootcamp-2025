...
class ExampleService:
    ...
    async def handle_request(self, request: Request):
        ...
        # TODO: ask OPEA if handle_message is intentional to only have the last two messagess
        # because the dictionary keys overwrite previous ones so you won't get full 
        # NOTE: i think handle_message should not be used when you are directly passing to an LLM 
        # i think this is for formatting for an earlier model in the pipeline which we don't have
        ...
        print("\n")
        print("PAYLOAD: ", json.dumps(initial_inputs))
        ...
        #         if hasattr(llm_response, 'status_code'):
        #             print("Status code:", llm_response.status_code)
        #         if hasattr(llm_response, 'headers'):
        #             print("Headers:", llm_response.headers)
        ...
        #                 response_body += chunk
        #             print(f"\nFull response body: {response_body}")
        #         except Exception as e:
        ...
        #             if isinstance(content_json, dict) and 'response' in content:
        #                 content = content_json['response']
        #         except json.JSONDecodeError:
        #             # If not JSON, usse the raw content
        #             pass
        #         except Exception as e:
